...
You must add Vifm-Colors on github to enable the themes I use.

You must also have Zsh, because this Vifm config automatically launches a Zsh shell on the right.
